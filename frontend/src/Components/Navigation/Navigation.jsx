        ...
        <div className={navcss["layout-navigation"]}>
          ...
          <div className={navcss["center-bar"]}>
            <NavLink
              to="/"
              className={({ isActive }) =>
                `${navcss["iconprivate"]} ${isActive ? navcss["active"] : ""}`
              }
            >
              {({ isActive }) => (
                <img
                  src={isActive ? "homeIconActive.svg" : "homeIcon.svg"}
                  alt="home"
                />
              )}
            </NavLink>
            ...
            >
              {({ isActive }) => (
                <img
                  src={isActive ? "plusIconActive.svg" : "plusIcon.svg"}
                  alt="plus"
                />
              )}
            </NavLink>
            ...
            <NavLink
              ...
              className={({ isActive }) =>
                `${navcss["iconprivate"]} ${
                  isActive ? navcss["active"] : undefined
                }`
              }
            >
              {({ isActive }) => (
                <img
                  src={isActive ? "userIconActive.svg" : "userIcon.svg"}
                  alt="user"
                />
              )}
            </NavLink>
          ...
          <div className={navcss["bottom-bar"]}>
            <div
              className={`${navcss["bar"]} ${
                compassActive === true ? navcss["active"] : undefined
              }`}
              onClick={() => {
